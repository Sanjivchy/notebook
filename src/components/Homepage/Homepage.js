    ...
    return (
        <div>
            ...
            <div className="flex  flex-col justify-center items-center md:items-start m-5 row-start-1">
                ...
                <a href="#" className="py-2 px-4 rounded text-base flex flex-row justify-around items-center bg-indigo-600 text-indigo-100 md:text-lg ml-4 border-solid border border-blue-500">Get Started <i class=" pl-2 fas fa-arrow-right"></i></a>
            </div>
